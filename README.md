...
This is a C program that implements the Tic-Tac-Toe game (*Jogo do Galo*, in portuguese).

It is up to you to provide the missing code for the functions `printBoard` and `checkGameEnd`. The game's control logic is already implemented.
